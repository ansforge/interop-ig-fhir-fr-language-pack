...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/fr/CodeSystem/cs-fr-v3-mediaType | *Version*:0.1.0 |
...
```json
{
  ...
  "id" : "cs-fr-v3-mediaType",
  "language" : "fr",
  "url" : "https://interop.esante.gouv.fr/ig/fhir/fr/CodeSystem/cs-fr-v3-mediaType",
  "version" : "0.1.0",
  "name" : "MediaType",
  "title" : "Media Type",
  "status" : "active",
