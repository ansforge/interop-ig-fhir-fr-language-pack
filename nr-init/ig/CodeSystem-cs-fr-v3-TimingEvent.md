...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/fr/CodeSystem/cs-fr-v3-TimingEvent | *Version*:0.1.0 |
...
```json
{
  ...
  "id" : "cs-fr-v3-TimingEvent",
  "language" : "fr",
  "url" : "https://interop.esante.gouv.fr/ig/fhir/fr/CodeSystem/cs-fr-v3-TimingEvent",
  "version" : "0.1.0",
  "name" : "TimingEvent",
  "title" : "TimingEvent",
  "status" : "active",
